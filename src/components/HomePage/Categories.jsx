    ...
    <div className='w-full mt-16 pb-10'>
        <div className='w-[90%]  md:h-[500px] lg:h-[700px] mx-auto'>
            ...
            <div className='w-full sm:flex gap-4'>
                ...
                <div className='w-full mt-4 sm:mt-0 lg:w-2/6 xl:w-1/5 h-[150px] sm:h-[200px] lg:h-[300px] relative group hover:w-4/5 rounded-xl border duration-300 cursor-pointer'>
            ...
            <div className='w-full sm:flex gap-4 mt-5'>
                <div className='w-full lg:w-2/6 xl:w-1/5 h-[150px] sm:h-[200px] lg:h-[300px] relative group hover:w-4/5 rounded-xl border duration-300 cursor-pointer'>
                ...
                <div className='mt-4 sm:mt-0 w-full lg:w-2/6 xl:w-1/5 h-[150px] sm:h-[200px] lg:h-[300px] relative group hover:w-4/5 rounded-xl border duration-300 cursor-pointer'>
                ...
                <div className='mt-4 sm:mt-0 w-full lg:w-2/3 xl:w-3/5 h-[150px] sm:h-[200px] lg:h-[300px] relative group hover:w-4/5 rounded-xl border duration-300 cursor-pointer'>
