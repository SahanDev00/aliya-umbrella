...
const Navbar = () => {
  ...
  return (
    <div className='w-screen'>
        <div className={`fixed w-[85%] md:w-[90%] lg:w-3/4 xl:w-3/5 bg-white md:bg-white/60 border-black border-2 mt-5 z-50 right-0 left-0 mx-auto rounded-3xl md:backdrop-blur-md duration-300 shadow-md overflow-hidden ${navbar ? 'h-[400px]' : 'h-[80px]'}`}>
        ...
        {/* searchbar */}
        {search && (
            <div className='fixed flex items-center bg-white/40 backdrop-blur-md w-[95%] md:w-[90%] h-[50px] rounded-2xl lg:w-3/4 xl:w-3/5 shadow-md mx-auto right-0 left-0 top-[12%] translate-y-4 transform float-up'>
