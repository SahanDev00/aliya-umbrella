    ...
    <div className='w-full min-h-screen pb-10 bg-white'>
        ...
        <div className='w-full md:w-[90%] mx-auto h-full'>
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>Who We Are</h1>
            ...
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>Why We Are</h1>
            ...
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>Our Products and Materials We Use</h1>
            ...
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>30 Inch Size</h1>
            ...
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>Automatic Opening</h1>
            ...
            <div className='pl-5 sm:pl-10 mt-10'>
                <h1 className='text-xl md:text-2xl font-medium font-overpass text-amber'>High Quality Material</h1>
